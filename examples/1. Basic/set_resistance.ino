...
void setup() {
  ...
  pot.setResistance(5769);  // Any random value. DigiPot will round to nearest 100Ω
  
  // The setResistance function will automatically save the resistance to in-built EEPROM
